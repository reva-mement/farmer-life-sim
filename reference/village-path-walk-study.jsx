...
// A bone that hangs straight down from a pivot's own local origin (0,0,0) to
// (0,-length,0). Meant to be a CHILD of a THREE.Group "joint pivot" — rotating
// the pivot on a single axis (rotation.x) swings the bone naturally, since the
// bone itself never needs its own rotation. This sidesteps the multi-axis
// rotation-order trap that caused the earlier tile bug.
...
export default function VillagePathWalkStudy() {
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: 18, color: "#3a2e22", fontWeight: 700 }}>道を往復する農民</div>
      <div
        ref={mountRef}
        style={{
